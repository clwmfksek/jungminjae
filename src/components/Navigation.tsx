...
import { FaHome, FaGamepad, FaComments, FaUser, FaSun, FaMoon, FaChartLine, FaTrophy, FaCog, FaSignOutAlt } from 'react-icons/fa';
        ...
        <div className="nav-links">
          ...
          {user && (
            <>
              ...
              <Link to="/count" className={`nav-item ${isActive('/count') ? 'active' : ''}`}>
        ...
        <div className="user-section">
          {user && bestRecord !== null && (
            <div className="best-record">
              ...
              <span className="record-value">{bestRecord.toFixed(3)}초</span>
            </div>
          )}
                ...
                <div className="profile-dropdown-menu">
                  ...
                  <div className="profile-stats">
                    <div className="stat-item">
                      ...
                      <span className="stat-value">{bestRecord?.toFixed(3)}초</span>
                    </div>
                  </div>
